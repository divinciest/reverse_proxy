...
const TagCard: React.FC<TagCardProps> = ({ tag, onDelete, onEdit, onViewNetwork, allTags }) => {
        ...
        <Button
          ...
          onClick={() => {
            if (typeof onViewNetwork === 'function') {
              ...
              console.error('TagCard: onViewNetwork prop is not a function or not provided.', { tag });
            }
          }}
