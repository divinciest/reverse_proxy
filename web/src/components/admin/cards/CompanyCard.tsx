...
const CompanyCard: React.FC<CompanyCardProps> = ({
  company, onDelete, onAddLogo, onToggleStatus, onToggleIsFirm,
}) => {
  return (
    <Card className="flex flex-col justify-between hover:shadow-md transition-all duration-200 bg-card border-border shadow-sm">
