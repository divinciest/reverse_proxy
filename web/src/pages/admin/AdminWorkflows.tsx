 ...
 * AdminWorkflows.tsx
 * 
 * This component serves as the main dashboard for managing all workflow definitions.
 * It provides a high-level view of all created workflows, allowing administrators
 * to create, view, and manage them. This page is the central hub for interacting
 * with the workflow engine from the frontend.
 */
